...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.browse', {
    ...
    views: {
      ...
      .state('app.playlistsCf', {
        url: '/playlistsCf',
        views: {
          'menuContent': {
            templateUrl: 'templates/playlistsCf.html',
            controller: "servicioCfCtrl"
          }
        }
      })
      ...
      .state('app.playlistsBook', {
        url: '/playlistsBook',
        views: {
          'menuContent': {
            templateUrl: 'templates/playlistsBook.html',
            controller: "servicioBookCtrl"
          }
        }
      })
